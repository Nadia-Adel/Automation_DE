...
public class TC010_pushNotification_netzabdechung_Prepaid extends MobileTestBase {
	...
	public void Step2_HandlePushNotificationFromForeground() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("Netzabdeckung_DEEPLINK");
		notifcationMessage = UrbanAirshipAPI_NotificationBody_Handeller.getRequiredMessage("Netzabdeckung_DEEPLINK_NotificationMessage");
	...
	@Test(priority = 3)
	public void Step3_ValidateTheNetzabdeckungAction_FrontGround() {
	...
	@Test(priority = 5)
	public void Step5_ValidateTheNetzabdeckungAction_Backround() {
	...
	@Test(priority = 7)
	public void Step7_ValidateTheNetzabdeckungAction_AfterKillingTheApp() {
