...
public class TC023_ActualCost_ALM extends MobileTestBase{
	...
	public void Step1_uploadRequiredCMS() throws IOException, InterruptedException  {
		CMDFeatures.RunBashScriptToUpdateCMSFile_Parameterized(CMSConfigFilesReader.getRequiredPath("bashScriptToUploadCMS_Path"), CMSConfigFilesReader.getRequiredPath("ActualCost_FirstEligible_SquareTile_Empty"));
	...
	public void Step4_ValidateSquareTile() {
		...
		assertEquals(Mobile_CommonActions_Get.getText(homePageObject.squareTileSubline),"Auto_ActualCostSubline_TC23_ALM");
