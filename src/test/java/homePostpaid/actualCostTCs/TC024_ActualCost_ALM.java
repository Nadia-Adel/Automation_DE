...
public class TC024_ActualCost_ALM extends MobileTestBase{
	...
	public void Step1_uploadRequiredCMS() throws IOException, InterruptedException  {
		...
		CMDFeatures.RunBashScriptToUpdateCMSFile_Parameterized(CMSConfigFilesReader.getRequiredPath("bashScriptToUploadCMS_Path"), CMSConfigFilesReader.getRequiredPath("ActualCost_FirstEligible_SquareTile_invalidID"));
	...
	public void Step4_ValidateSquareTile() {
		...
		assertEquals(Mobile_CommonActions_Get.getText(homePageObject.squareTileHeadline),"Speedtest_Automation");
		assertEquals(Mobile_CommonActions_Get.getText(homePageObject.squareTileSubline),"Speedtest_Subline_Automation_TC21");
