...
public class TC026_ActualCost_ALM extends MobileTestBase{
	...
	public void Step1_uploadRequiredCMS() throws IOException, InterruptedException  {
		...
		CMDFeatures.RunBashScriptToUpdateCMSFile_Parameterized(CMSConfigFilesReader.getRequiredPath("bashScriptToUploadCMS_Path"), CMSConfigFilesReader.getRequiredPath("ActualCost_FirstELigible_TC26_ALM"));
	...
	public void Step4_ValidateSquareTile() {
		...
		assertEquals(Mobile_CommonActions_Get.getText(homePageObject.squareTileSubline),"SpeedTest_Automation_TC26");
