...
public class TC011_ActualCost_ALM extends MobileTestBase{
	...
	public void Step1_uploadRequiredCMS() throws IOException, InterruptedException  {
		CMDFeatures.RunBashScriptToUpdateCMSFile_Parameterized(CMSConfigFilesReader.getRequiredPath("bashScriptToUploadCMS_Path"), CMSConfigFilesReader.getRequiredPath("ActualCost_FirstEligible_SquareTile_ValidLink"));
	...
	public void Step4_ValidateSquareTileInvalidDeeplink() {
		...
		pagesValidatorObject_mobile.validateCurrentCostDeepLinkAction();
