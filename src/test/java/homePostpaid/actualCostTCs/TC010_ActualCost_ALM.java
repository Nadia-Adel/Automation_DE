...
public class TC010_ActualCost_ALM extends MobileTestBase{
	...
	public void Step1_uploadRequiredCMS() throws IOException, InterruptedException  {
		CMDFeatures.RunBashScriptToUpdateCMSFile_Parameterized(CMSConfigFilesReader.getRequiredPath("bashScriptToUploadCMS_Path"), CMSConfigFilesReader.getRequiredPath("ActualCost_FirstEligible_SquareTile_InvalidTemp"));
	...
	@Test(priority = 4 )
	public void Step4_ValidateSquareTileInvalidTempName() {
