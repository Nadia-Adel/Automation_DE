...
public class TC056_FailSubscriberDotDoRequest401_CYCC  extends MobileTestBase{
	...
	public void Step2_FailResponseWith401() throws IOException, ParseException, InterruptedException {
		resFilePath=SandboxConfigReader.getProberty("SubscriberDotDo_Get_401_Path");
		apiURL=SandboxConfigReader.getProberty("SubscriberDotDo_Get_URL");
	...
	public void setStatusCode200() throws InterruptedException, IOException {
		resFilePath=SandboxConfigReader.getProberty("SubscriberDotDo_Get_200_Path");
		apiURL=SandboxConfigReader.getProberty("SubscriberDotDo_Get_URL");
		stubsName = SandboxConfigReader.getProberty("automationStubs_CYCC");
		textAreaXPath = "/html/body/div[2]/div[2]/div/div[4]/div/div[1]/div/div/div[2]/div/div[57]/div[2]/form/div/div[2]/div[2]/textarea";
		setStatusCode(resFilePath, apiURL, stubsName,textAreaXPath);
