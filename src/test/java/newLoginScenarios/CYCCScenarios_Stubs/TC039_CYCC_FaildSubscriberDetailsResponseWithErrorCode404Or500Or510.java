...
public class TC039_CYCC_FaildSubscriberDetailsResponseWithErrorCode404Or500Or510 extends MobileTestBase {
	...
	@Test(priority = 2)
	public void Step2_failResponseWith404() throws InterruptedException, IOException {

		resFilePath=SandboxConfigReader.getProberty("SubscriberDetails_Get_404_Path");
