...
public class DeeplinkPagesValidator_Mobile {


	public DeeplinkPagesValidator_Mobile(AppiumDriver<MobileElement>appium) {
	...
	@iOSXCUITFindBy(id="//XCUIElementTypeOther[@name=\"Verbindungskosten\"]")
	public WebElement currentCostPageTitle;
	
	
	public void validateCurrentCostDeepLinkAction() {
		Mobile_CommonActions_Set.setExplicitWait(currentCostPageTitle, 300);
	}
