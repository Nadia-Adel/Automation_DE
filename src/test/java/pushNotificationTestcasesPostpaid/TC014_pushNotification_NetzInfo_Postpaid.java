...
public class TC014_pushNotification_NetzInfo_Postpaid extends MobileTestBase {
	...
	public void Step2_HandlePushNotificationFromFrontgound() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("NetzInfo_DEEPLINK");
	...
	@Test(priority = 3)
	public void Step3_ValidateTheNetzInfoPageDeeplinkAction_FrontGround() {
	...
	@Test(priority = 7)
	public void Step7_ValidateTheNetzInfoPageDeeplinkAction_AfterKillingTheApp() {
