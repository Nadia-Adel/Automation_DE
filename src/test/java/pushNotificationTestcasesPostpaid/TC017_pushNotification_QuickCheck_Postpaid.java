...
public class TC017_pushNotification_QuickCheck_Postpaid extends MobileTestBase {
	...
	public void Step2_HandlePushNotificationFromFrontgound() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("QuickCheck_DEEPLINK");
		notifcationMessage =UrbanAirshipAPI_NotificationBody_Handeller.getRequiredMessage("QuickCheck_DEEPLINK_NotificationMessage");
	...
	@Test(priority = 3)
	public void Step3_ValidateTheQuickCheckDeeplinkAction_FrontGround() {
		
		System.out.println("Step 3, Validate Quick Check Deeplink Action  ......");
		
		pagesValidatorObject = new DeeplinkPagesValidator_Mobile(GlobalDriver.appium);
		pagesValidatorObject.validateQuickCheckDeeplinkAction();
	}
	...
	@Test(priority = 5)
	public void Step5_ValidateTheQuickCheckDeeplinkAction_Backround() {

		System.out.println("Step 5, validate Quick Check Deeplink Action ......");
	...
	@Test(priority = 7)
	public void Step7_ValidateTheQuickCheckDeeplinkAction_AfterKillingTheApp() {
		
		System.out.println("Step 7, validate Quick Check Deeplink Action......");
