...
public class TC006_pushNotification_Tariff_Postpaid extends MobileTestBase {
	...
	public void Step2_HandlePushNotificationFromFrontgound() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("TARIFF_DEEPLINK");
	...
	@Test(priority = 3)
	public void Step3_ValidateTheTariffPage_FrontGround() {
	...
	@Test(priority = 5)
	public void Step5_ValidateTheTariffPage_Backround() {
	...
	@Test(priority = 7)
	public void Step7_ValidateTheTariffPage_AfterKillingTheApp() {
