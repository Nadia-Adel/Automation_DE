...
public class TC013_pushNotification_SettingsAndInfo_Prepaid extends MobileTestBase {
	...
	public void Step1_mobileLogin() throws IOException, ParseException {
		...
		//menuObject.clickMobileSettingsMenuItem();
	}
	...
	public void Step2_HandlePushNotificationFromForeground() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("SettingsAndInfo_DEEPLINK");
		notifcationMessage = UrbanAirshipAPI_NotificationBody_Handeller.getRequiredMessage("SettingsAndInfo_DEEPLINK_NotificationMessage");
	...
	@Test(priority = 3)
	public void Step3_ValidateTheInfoPageDeeplinkAction_FrontGround() {
		
		System.out.println("Step 3, Validate Info Page Deeplink Action  ......");
		
		pagesValidatorObject = new DeeplinkPagesValidator_Mobile(GlobalDriver.appium);
		pagesValidatorObject.validateInfoDeeplinkAction();
	}
	...
	@Test(priority = 5)
	public void Step5_ValidateTheInfoPageDeeplinkAction_Backround() {

		System.out.println("Step 5, validate Info Page Deep link Action ......");
	...
	@Test(priority = 7)
	public void Step7_ValidateTheInfoPageDeeplinkAction_AfterKillingTheApp() {
		
		System.out.println("Step 7, validate Info Page Deep link Action......");
