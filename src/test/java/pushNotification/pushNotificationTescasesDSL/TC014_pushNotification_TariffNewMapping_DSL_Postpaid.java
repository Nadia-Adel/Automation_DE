...
public class TC014_pushNotification_TariffNewMapping_DSL_Postpaid extends MobileTestBase {
	...
	String deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("Tariff_NewMapping_DEEPLINK");
	...
	public void Step2_HandlePushNotificationFromForeground() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("Tariff_NewMapping_DEEPLINK");
		notifcationMessage = UrbanAirshipAPI_NotificationBody_Handeller.getRequiredMessage("Tariff_NewMapping_DEEPLINK_NotificationMessage");
