...
public class TC008_pushNotification_BillDeeplink_DSL extends MobileTestBase {
	...
	String deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("BillsDEEPLINK");
	...
	public void Step2_HandlePushNotificationFromFrontgound() {
		...
		deepLink = UrbanAirshipAPIConfigHandeller.getReguiredDEEPLINK("BillsDEEPLINK");
		notifcationMessage = UrbanAirshipAPI_NotificationBody_Handeller.getRequiredMessage("BillsDEEPLINK_NotificationMessage");
